...
if (seed == 1) {
	...
	if (instance_number(obj_enemy_bomb_mom_spiked2) < 2)
...
//randomly decide where they will spawn
	...
	if (_spawnNum >= 1) {
		...
		var inNum = instance_number(obj_enemy_bbbird_s) + instance_number(obj_enemy_bbbird_s2);
		if (enemy == obj_enemy_bbbird_s || enemy == obj_enemy_bbbird_s2) spawn1.set_dir = inNum * 90;
	}
	...
	if (_spawnNum >= 2) {
		...
		var inNum = instance_number(obj_enemy_bbbird_s) + instance_number(obj_enemy_bbbird_s2);
		if (enemy == obj_enemy_bbbird_s || enemy == obj_enemy_bbbird_s2) spawn2.set_dir = inNum * 90;
	}
	...
	if (_spawnNum >= 3) {
		...
		var inNum = instance_number(obj_enemy_bbbird_s) + instance_number(obj_enemy_bbbird_s2);
		if (enemy == obj_enemy_bbbird_s || enemy == obj_enemy_bbbird_s2) spawn3.set_dir = inNum * 90;
	}
	...
	if (_spawnNum >= 4) {
		...
		var inNum = instance_number(obj_enemy_bbbird_s) + instance_number(obj_enemy_bbbird_s2);
		if (enemy == obj_enemy_bbbird_s || enemy == obj_enemy_bbbird_s2) spawn4.set_dir = inNum * 90;
	}
