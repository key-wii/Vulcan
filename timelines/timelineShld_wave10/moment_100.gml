...
if (seed == 1) {
	...
	var enemy3 = obj_enemy_r_viper_circle;
	var enemy4 = obj_enemy_r_quickshot;
} else if (seed == 3) {
	var enemy1 = obj_enemy_b_viper;
	var enemy2 = obj_enemy_flamer_fast;
	var enemy3 = obj_enemy_r_viper_circle;
	...
	if (instance_number(obj_enemy_SH_shield) <= 1)
		var enemy4 = obj_enemy_SH1;
	else var enemy4 = obj_enemy_b_viper;
} else if (seed == 6) {
	var enemy1 = obj_enemy_flamer_fast;
	var enemy2 = obj_enemy_b_viper;
	var enemy3 = obj_enemy_s_viper_circle;
	if (instance_number(obj_enemy_SH_shield) <= 1)
		var enemy4 = obj_enemy_SH1;
	...
	var enemy2 = obj_enemy_b_viper_circle;
	var enemy3 = obj_enemy_candler;
	...
	var enemy2 = obj_enemy_b_viper;
	var enemy3 = obj_enemy_flamer_fast;
	var enemy4 = obj_enemy_b_viper_circle;
} else if (seed == 11) {
	if (instance_number(obj_enemy_SH_shield) <= 2)
		var enemy1 = obj_enemy_SH1;
	else var enemy1 = obj_enemy_b_viper_circle;
	var enemy2 = obj_enemy_r_viper_circle;
	var enemy3 = obj_enemy_r_quickshot;
	var enemy4 = obj_enemy_r_viper_circle;
} else if (seed == 12) {
	if (instance_number(obj_enemy_SH_shield) <= 2)
		var enemy1 = obj_enemy_SH1;
	...
	else var enemy3 = obj_enemy_b_viper;
	var enemy4 = obj_enemy_flamer_fast;
} else if (seed == 15) {
	var enemy1 = obj_enemy_flamer_fast;
	var enemy2 = obj_enemy_r_viper_circle;
