...
if (global.checkpoint < 26 && enemies >= 36) exit;
else if (global.checkpoint < 30 && enemies >= 43) exit;
else if (enemies >= 20) exit;
...
if (seed == 1 && global.checkpoint < 22) seed = 0;
else if (seed == 8 && global.checkpoint > 25 && global.checkpoint < 30) seed = 1;
if (seed == 1) {
	var sp = irandom_range(1, 4);
	if (sp == 1) {
		if (instance_number(obj_enemy_laser) < 1)
