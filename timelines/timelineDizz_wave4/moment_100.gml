...
if (seed == 1) {
	...
	else var enemy3 = obj_enemy_s_armor_big;
	...
	else var enemy4 = obj_enemy_s_quickshot;
} else if (seed == 3) {
	if (instance_number(obj_enemy_bbbird_s) <= 3)
		var enemy1 = obj_enemy_bbbird_s;
	...
	else var enemy2 = obj_enemy_s_viper;
	...
	if (instance_number(obj_enemy_mage_big_circle) < 7)
		var enemy4 = obj_enemy_mage_big_circle;
	else var enemy4 = obj_enemy_s_viper;
} else if (seed == 15) {
