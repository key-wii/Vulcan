...
if (global.checkpoint < 26 && enemies >= 39) exit;
else if (global.checkpoint < 30 && enemies >= 52) exit;
else if (enemies >= 14) exit;
...
if (seed == 1) {
	...
	if (sp == 1) {
		...
		spawn4.enemy = obj_enemy_b_viper_wide_circle_spiked2;
	}
	if (sp == 2) {
		spawn1.enemy = obj_enemy_b_viper_wide_circle_spiked2;
	...
	if (sp == 3) {
		...
		spawn2.enemy = obj_enemy_b_viper_wide_circle_spiked2;
	...
	if (sp == 4) {
		spawn1.enemy = obj_enemy_bomber_spiked;
		spawn2.enemy = obj_enemy_bomber_spiked;
		spawn3.enemy = obj_enemy_b_viper_wide_circle_spiked2;
		spawn4.enemy = obj_enemy_r_grenader_big_spiked;
	}
} else if (seed == 2) {
	spawn1.enemy = obj_enemy_candler_spiked2;
	spawn2.enemy = obj_enemy_r_viper_wide_spiked;
	spawn3.enemy = obj_enemy_candler_spiked2;
	spawn4.enemy = obj_enemy_r_viper_wide_spiked;
} else if (seed == 3 ) {
	spawn1.enemy = obj_enemy_r_viper_wide_spiked;
	spawn2.enemy = obj_enemy_candler_spiked2;
	spawn3.enemy = obj_enemy_r_viper_wide_spiked;
	spawn4.enemy = obj_enemy_candler_spiked2;
} else if (seed == 4) {
	var sp = irandom_range(1, 4);
	if (sp == 1) {
	...
	spawn1.enemy = obj_enemy_b_grenader_big_spiked2;
	spawn2.enemy = obj_enemy_b_grenader_big_spiked2;
	spawn3.enemy = obj_enemy_b_grenader_big_spiked2;
	spawn4.enemy = obj_enemy_b_grenader_big_spiked2;
} else if (seed == 6) {
	spawn1.enemy = obj_enemy_s_grenader_big_spiked2;
	spawn2.enemy = obj_enemy_s_grenader_big_spiked2;
	spawn3.enemy = obj_enemy_s_grenader_big_spiked2;
	spawn4.enemy = obj_enemy_s_grenader_big_spiked2;
