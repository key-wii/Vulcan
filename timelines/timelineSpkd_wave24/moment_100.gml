...
if (seed == 1) {
	...
	var enemy3 = obj_enemy_flamer_fast_spiked
	...
	var enemy2 = obj_enemy_flamer_fast_spiked;
	var enemy3 = obj_enemy_b_grenader_big_spiked2;
	var enemy4 = obj_enemy_flamer_fast_spiked;
} else if (seed == 4) {
	if (instance_number(obj_enemy_bbbird_s) <= 1)
		var enemy1 = obj_enemy_bbbird_s;
	...
	if (instance_number(obj_enemy_bbbird_s) <= 1)
		var enemy1 = obj_enemy_bbbird_s;
	else var enemy1 = obj_enemy_flamer_fast_spiked;
	var enemy2 = obj_enemy_flamer_fast_spiked2;
