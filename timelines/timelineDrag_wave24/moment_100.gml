...
if (seed == 1) {
	...
	if (instance_number(obj_enemy_controller_parent) < 4)
		var enemy2 = obj_enemy_lizard_r_controller;
	else var enemy2 = obj_enemy_slime;
	if (instance_number(obj_enemy_dragonfly_s) <= 6)
		var enemy3 = obj_enemy_dragonfly_s;
	...
	if (instance_number(obj_enemy_controller_parent) < 3)
		var enemy3 = obj_enemy_lizard_controller;
	else var enemy3 = obj_enemy_b_grenader_big;
	var enemy4 = obj_enemy_r_grenader_big;
} else if (seed == 14) {
	if (instance_number(obj_enemy_controller_parent) < 4)
		var enemy1 = obj_enemy_lizard_r_controller;
	else var enemy1 = obj_enemy_b_viper_wide;
	...
	if (instance_number(obj_enemy_controller_parent) < 3)
		var enemy3 = obj_enemy_lizard_r_controller;
	...
	var enemy2 = obj_enemy_b_viper_wide_circle;
	if (instance_number(obj_enemy_controller_parent) < 3)
	...
	if (instance_number(obj_enemy_controller_parent) < 2)
		var enemy4 = obj_enemy_lizard_r_controller;
