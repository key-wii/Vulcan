...
if (seed == 1) {
	...
	if (instance_number(obj_enemy_mage_big_circle) < 8)
		var enemy3 = obj_enemy_mage_big_circle;
	else var enemy3 = obj_enemy_s_grenader_big;
	var enemy4 = obj_enemy_b_quickshot;
} else if (seed == 2) {
	if (instance_number(obj_enemy_bbbird_s) <= 3)
		var enemy1 = obj_enemy_bbbird_s;
	else var enemy1 = obj_enemy_mage_big_circle;
	var enemy2 = obj_enemy_b_quickshot;
	var enemy3 = obj_enemy_r_viper;
	if (instance_number(obj_enemy_mage_big_circle) < 8)
		var enemy4 = obj_enemy_mage_big_circle;
	else var enemy4 = obj_enemy_s_grenader_big;
} else if (seed == 3) {
	if (instance_number(obj_enemy_bbbird_s) <= 3)
		var enemy1 = obj_enemy_bbbird_s;
	else var enemy1 = obj_enemy_b_quickshot;
	if (!instance_exists(obj_enemy_candler_big))
		var enemy2 = obj_enemy_candler_big;
	else var enemy2 = obj_enemy_slime;
	var enemy3 = obj_enemy_s_grenader_big;
	var enemy4 = obj_enemy_b_viper_circle;
} else if (seed == 4) {
	if (instance_number(obj_enemy_mage_big_circle) < 8)
		var enemy1 = obj_enemy_mage_big_circle;
	else var enemy1 = obj_enemy_s_grenader_big;
	if (instance_number(obj_enemy_mage_big_circle) < 7)
		var enemy2 = obj_enemy_mage_big_circle;
	else var enemy2 = obj_enemy_r_viper;
	if (!instance_exists(obj_enemy_candler_big))
		var enemy3 = obj_enemy_candler_big;
	else var enemy3 = obj_enemy_slime;
	if (instance_number(obj_enemy_bbbird_s) <= 3)
		var enemy4 = obj_enemy_bbbird_s;
	else var enemy4 = obj_enemy_b_quickshot;
} else if (seed == 5) {
	...
	var enemy2 = obj_enemy_s_viper_wide;
	if (!instance_exists(obj_enemy_candler_big))
		var enemy3 = obj_enemy_candler_big;
	else var enemy3 = obj_enemy_slime;
	var enemy4 = obj_enemy_b_quickshot;
	...
	if (instance_number(obj_enemy_mage_big_circle) < 7)
		var enemy2 = obj_enemy_mage_big_circle;
	else var enemy2 = obj_enemy_b_viper_circle;
	var enemy3 = obj_enemy_b_viper_circle;
	var enemy4 = obj_enemy_b_viper_circle;
} else if (seed == 12) {
	if (instance_number(obj_enemy_mage_big_circle) < 8)
		var enemy1 = obj_enemy_mage_big_circle;
	else var enemy1 = obj_enemy_s_viper_circle;
	var enemy2 = obj_enemy_s_viper_circle;
	if (!instance_exists(obj_enemy_candler_big))
		var enemy3 = obj_enemy_candler_big;
	else var enemy3 = obj_enemy_slime;
	...
	if (instance_number(obj_enemy_mage_big_circle) < 8)
		var enemy3 = obj_enemy_mage_big_circle;
	else var enemy3 = obj_enemy_b_quickshot;
	if (instance_number(obj_enemy_mage_big_circle) < 7)
		var enemy4 = obj_enemy_mage_big_circle;
	else var enemy4 = obj_enemy_s_viper_wide;
} else if (seed == 15) {
	if (instance_number(obj_enemy_mage_big_circle) < 8)
		var enemy1 = obj_enemy_mage_big_circle;
	else var enemy1 = obj_enemy_flamer;
	...
	if (instance_number(obj_enemy_mage_big_circle) < 7)
		var enemy3 = obj_enemy_mage_big_circle;
	else var enemy3 = obj_enemy_r_viper;
	if (instance_number(obj_enemy_mage_big_circle) < 6)
		var enemy4 = obj_enemy_mage_big_circle;
	else var enemy4 = obj_enemy_r_viper;
} else if (seed == 16) {
	if (instance_number(obj_enemy_mage_big_circle) < 8)
		var enemy1 = obj_enemy_mage_big_circle;
	else var enemy1 = obj_enemy_b_viper_circle;
	...
	if (instance_number(obj_enemy_mage_big_circle) < 5)
		var enemy4 = obj_enemy_mage_big_circle;
