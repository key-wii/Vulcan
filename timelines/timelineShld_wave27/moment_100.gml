...
if (seed == 1) {
	...
	var enemy3 = obj_enemy_s_3round_circle;
	...
	var enemy4 = obj_enemy_s_viper_circle;
} else if (seed == 3) {
	...
	var enemy1 = obj_enemy_s_viper_circle;
	var enemy2 = obj_enemy_b_viper_wide;
	var enemy3 = obj_enemy_s_viper_wide;
	var enemy4 = obj_enemy_b_viper_wide;
} else if (seed == 6) {
	...
	var enemy2 =  obj_enemy_s_3round;
	var enemy3 = obj_enemy_b_viper_wide;
	var enemy4 = obj_enemy_s_3round_circle;
} else if (seed == 14) {
	var enemy1 = obj_enemy_b_viper_circle;
	var enemy2 = obj_enemy_b_viper_wide;
	if (instance_number(obj_enemy_SH2) == 0)
	...
	if (instance_number(obj_enemy_SH1_fast_circle) <= 2)
		var enemy1 = obj_enemy_SH1_fast_circle;
