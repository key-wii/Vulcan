...
if (seed == 1) {
	var enemy1 = obj_enemy_r_viper_spiked;
	var enemy2 = obj_enemy_flamer_spiked;
	var enemy3 = obj_enemy_r_grenader_big;
	var enemy4 = obj_enemy_s_viper_circle_spiked;
} else if (seed == 2) {
	var enemy1 = obj_enemy_s_viper_circle_spiked;
	var enemy2 = obj_enemy_s_viper_circle_spiked;
	var enemy3 = obj_enemy_r_spiked;
	var enemy4 = obj_enemy_s_spiked2;
} else if (seed == 3) {
	var enemy1 = obj_enemy_s_viper_circle_spiked;
	var enemy2 = obj_enemy_candler_spiked;
	var enemy3 = obj_enemy_s_viper_circle_spiked;
	var enemy4 = obj_enemy_r_spiked;
} else if (seed == 4) {
	var enemy1 = obj_enemy_s_armor_big_spiked;
	var enemy2 = obj_enemy_r_spiked;
	var enemy3 = obj_enemy_candler_spiked;
	var enemy4 = obj_enemy_s_viper_circle_spiked;
} else if (seed == 5) {
	var enemy1 = obj_enemy_s_spiked;
	var enemy2 = obj_enemy_s_armor_big_spiked;
	var enemy3 = obj_enemy_s_viper_circle_spiked;
	var enemy4 = obj_enemy_s_viper_circle_spiked;
} else if (seed == 6) {
	var enemy1 = obj_enemy_flamer_spiked;
	var enemy2 = obj_enemy_s_viper_circle_spiked;
	var enemy3 = obj_enemy_s_armor_big_spiked;
	var enemy4 = obj_enemy_s_spiked2;
} else if (seed == 7) {
	var enemy1 = obj_enemy_candler_spiked;
	var enemy2 = obj_enemy_s_armor_big_spiked;
	var enemy3 = obj_enemy_candler_spiked;
	var enemy4 = obj_enemy_s_viper_circle_spiked;
} else if (seed == 8) {
	...
	var enemy2 = obj_enemy_s_viper_circle_spiked;
	var enemy3 = obj_enemy_s_armor_big_spiked;
	var enemy4 = obj_enemy_r_viper_spiked;
} else if (seed == 10) {
	var enemy1 = obj_enemy_flamer_spiked;
	var enemy2 = obj_enemy_s_armor_big_spiked;
	var enemy3 = obj_enemy_candler_spiked;
	...
	var enemy4 = obj_enemy_candler_spiked;
} else if (seed == 12) {
	var enemy1 = obj_enemy_s_armor_big_spiked;
	var enemy2 = obj_enemy_s_armor_big_spiked;
	var enemy3 = obj_enemy_candler_spiked;
	...
	var enemy1 = obj_enemy_r_viper_spiked;
	var enemy2 = obj_enemy_s_spiked;
	var enemy3 = obj_enemy_s_viper_circle_spiked;
	var enemy4 = obj_enemy_s_spiked;
	...
	var enemy1 = obj_enemy_r_spiked;
	var enemy2 = obj_enemy_flamer_spiked;
	var enemy3 = obj_enemy_flamer_spiked;
	var enemy4 = obj_enemy_flamer_spiked;
}
