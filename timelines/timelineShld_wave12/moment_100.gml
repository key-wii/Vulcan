...
if (seed == 1) {
	...
	if (instance_number(obj_enemy_SH_shield) <= 1)
		var enemy1 = obj_enemy_SH1_fast;
	else var enemy1 = obj_enemy_s_armor_big;
	if (instance_number(obj_enemy_bbbird_s) <= 0)
		var enemy2 = obj_enemy_bbbird_s;
	...
	if (instance_number(obj_enemy_SH_shield) <= 0)
		var enemy1 = obj_enemy_SH1_fast;
	...
	if (instance_number(obj_enemy_bomb_mom) < 1)
		var enemy1 = obj_enemy_bomb_mom;
...
with (obj_tank_pilot) {
	...
	if (_spawnNum >= 1) {
		...
		if (enemy == obj_enemy_candler || enemy == obj_enemy_candler_big || enemy == obj_enemy_flamer ||
			enemy == obj_enemy_flamer_fast || string_count("controller", object_get_name(enemy)) > 0)
				lCap += 300;
