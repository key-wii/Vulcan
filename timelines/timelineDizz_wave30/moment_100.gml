...
if (seed == 1) {
	if (instance_number(obj_enemy_r_3round) <= 6)
	...
	if (instance_number(obj_enemy_dizzy_3round_circle) < 5)
		var enemy2 = obj_enemy_dizzy_3round_circle;
	...
	if (instance_number(obj_enemy_dizzy_3round_circle) < 5)
		var enemy1 = obj_enemy_dizzy_3round_circle;
	...
	if (instance_number(obj_enemy_dizzy_3round_circle) < 4)
		var enemy4 = obj_enemy_dizzy_3round_circle;
