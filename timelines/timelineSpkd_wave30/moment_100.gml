...
if (seed == 1) {
	...
	var enemy2 = obj_enemy_s_grenader_big_spiked;
	var enemy3 = obj_enemy_r_viper_wide_spiked;
	var enemy4 = obj_enemy_b_viper_wide_circle_spiked2;
} else if (seed == 2) {
	if (instance_number(obj_enemy_bbbird_s) <= 1)
		var enemy1 = obj_enemy_bbbird_s;
	else var enemy1 = obj_enemy_s_spiked2;
	var enemy2 = obj_enemy_s_3round_spiked;
	var enemy3 = obj_enemy_b_viper_wide_circle_spiked2;
	var enemy4 = obj_enemy_b_viper_wide_circle_spiked2;
} else if (seed == 3) {
	if (instance_number(obj_enemy_bbbird_s) <= 1)
		var enemy1 = obj_enemy_bbbird_s;
	...
	if (instance_number(obj_enemy_bbbird_s) <= 1)
		var enemy1 = obj_enemy_bbbird_s;
	else var enemy1 = obj_enemy_b_3round_circle_spiked2
	var enemy2 = obj_enemy_s_3round_spiked;
	...
	var enemy2 = obj_enemy_r_grenader_big_spiked;
	var enemy3 = obj_enemy_b_3round_circle_spiked2
	var enemy4 = obj_enemy_b_viper_wide_circle_spiked2;
} else if (seed == 6) {
	if (instance_number(obj_enemy_bbbird_s) <= 1)
		var enemy1 = obj_enemy_bbbird_s;
	...
	var enemy3 = obj_enemy_r_3round_spiked;
	var enemy4 = obj_enemy_b_viper_wide_circle_spiked2;
} else if (seed == 8) {
	if (instance_number(obj_enemy_bbbird_s2) <= 1)
		var enemy1 = obj_enemy_bbbird_s2;
	else var enemy1 = obj_enemy_r_grenader_big_spiked;
	var enemy2 = obj_enemy_s_3round_spiked;
	...
	if (instance_number(obj_enemy_bbbird_s2) <= 1)
		var enemy1 = obj_enemy_bbbird_s2;
	else var enemy1 = obj_enemy_candler_spiked2;
	...
	var enemy2 = obj_enemy_candler_spiked2;
	var enemy3 = obj_enemy_s_3round_circle_spiked2;
	var enemy4 = obj_enemy_s_3round_spiked;
} else if (seed == 12) {
	if (instance_number(obj_enemy_bbbird_s2) <= 1)
		var enemy1 = obj_enemy_bbbird_s2;
	else var enemy1 =  obj_enemy_b_grenader_big_spiked2;
	...
	var enemy2 = obj_enemy_b_viper_wide_circle_spiked2;
	...
	var enemy2 = obj_enemy_r_viper_wide_spiked;
	var enemy3 = obj_enemy_b_viper_wide_circle_spiked2;
	var enemy4 = obj_enemy_r_3round_spiked;
} else if (seed == 15) {
	if (instance_number(obj_enemy_bbbird_s3) <= 1)
		var enemy1 = obj_enemy_bbbird_s3;
	else var enemy1 = obj_enemy_b_viper_spiked;
	var enemy2 = obj_enemy_s_3round_circle_spiked2;
	var enemy3 = obj_enemy_b_viper_wide_circle_spiked2;
	var enemy4 = obj_enemy_r_grenader_big_spiked;
} else if (seed == 16) {
	if (instance_number(obj_enemy_bbbird_s3) <= 1)
	...
	var enemy2 = obj_enemy_b_3round_circle_spiked2;
	var enemy3 = obj_enemy_s_grenader_big_spiked;
	var enemy4 = obj_enemy_b_3round_circle_spiked2
	...
	if (instance_number(obj_enemy_bbbird_s3) <= 1)
		var enemy1 = obj_enemy_bbbird_s3;
	else var enemy1 = obj_enemy_slime_spiked;
	var enemy2 = obj_enemy_r_3round_spiked;
	var enemy3 = obj_enemy_r_grenader_big_spiked;
	var enemy4 = obj_enemy_candler_spiked2;
} else {
	if (instance_number(obj_enemy_bbbird_s3) <= 1)
		var enemy1 = obj_enemy_bbbird_s3;
	else var enemy1 = obj_enemy_candler_spiked;
	if (instance_number(obj_enemy_bomb_mom_spiked2) < 1)
		var enemy2 = obj_enemy_bomb_mom_spiked2;
	else var enemy2 = obj_enemy_b_grenader_big_spiked2;
	var enemy3 = obj_enemy_flamer_fast_spiked2;
...
//randomly decide where they will spawn
	var ddir; var lenx; var leny; var enemy; var lCap; var inNum;
	...
	if (_spawnNum >= 1) {
		...
		var spawn1 = instance_create_layer(lenx, leny, "Enemy", spawner);
			inNum = instance_number(obj_enemy_bbbird_s) + instance_number(obj_enemy_bbbird_s2) + instance_number(obj_enemy_bbbird_s3);
		if (enemy == obj_enemy_bbbird_s || enemy == obj_enemy_bbbird_s2 || enemy == obj_enemy_bbbird_s3) spawn1.set_dir = inNum * 90;
	}
	...
	if (_spawnNum >= 2) {
		...
		var spawn2 = instance_create_layer(lenx, leny, "Enemy", spawner);
			inNum = instance_number(obj_enemy_bbbird_s) + instance_number(obj_enemy_bbbird_s2) + instance_number(obj_enemy_bbbird_s3);
		if (enemy == obj_enemy_bbbird_s || enemy == obj_enemy_bbbird_s2 || enemy == obj_enemy_bbbird_s3) spawn2.set_dir = inNum * 90;
	}
	...
	if (_spawnNum >= 3) {
		...
		var spawn3 = instance_create_layer(lenx, leny, "Enemy", spawner);
			inNum = instance_number(obj_enemy_bbbird_s) + instance_number(obj_enemy_bbbird_s2) + instance_number(obj_enemy_bbbird_s3);
		if (enemy == obj_enemy_bbbird_s || enemy == obj_enemy_bbbird_s2 || enemy == obj_enemy_bbbird_s3) spawn3.set_dir = inNum * 90;
	}
	...
	if (_spawnNum >= 4) {
		...
		var spawn4 = instance_create_layer(lenx, leny, "Enemy", spawner);
			inNum = instance_number(obj_enemy_bbbird_s) + instance_number(obj_enemy_bbbird_s2) + instance_number(obj_enemy_bbbird_s3);
		if (enemy == obj_enemy_bbbird_s || enemy == obj_enemy_bbbird_s2 || enemy == obj_enemy_bbbird_s3) spawn4.set_dir = inNum * 90;
	}
