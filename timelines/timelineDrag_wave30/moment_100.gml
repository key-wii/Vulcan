...
if (seed == 1) {
	...
	if (instance_number(obj_enemy_controller_parent) < 5)
		var enemy3 = obj_enemy_hydra_b_controller;
	...
	if (instance_number(obj_enemy_dragonfly_s) <= 7)
		var enemy1 = obj_enemy_dragonfly_s;
	else var enemy1 = obj_enemy_r_quickshot;
	if (instance_number(obj_enemy_dragonfly_s) <= 6)
		var enemy2 = obj_enemy_dragonfly_s;
	else var enemy2 = obj_enemy_r_grenader_big;
	...
	if (instance_number(obj_enemy_dragonfly_s) <= 6)
		var enemy3 = obj_enemy_dragonfly_s;
	else var enemy3 = obj_enemy_s_grenader_big;
	var enemy4 = obj_enemy_slime;
} else if (seed == 11) {
	if (instance_number(obj_enemy_dragonfly_s) <= 7)
		var enemy1 = obj_enemy_dragonfly_s;
	...
	if (instance_number(obj_enemy_dragonfly_s) <= 6)
		var enemy3 = obj_enemy_dragonfly_s;
	else var enemy3 = obj_enemy_r_viper_wide_circle;
	...
	if (instance_number(obj_enemy_controller_parent) < 4)
		var enemy2 = obj_enemy_hydra_b_controller;
	else var enemy2 = obj_enemy_candler;
	var enemy3 = obj_enemy_r_viper_wide;
	var enemy4 = obj_enemy_s_grenader_big;
} else if (seed == 15) {
	...
	var enemy2 = obj_enemy_r_viper_wide;
	if (instance_number(obj_enemy_controller_parent) < 4)
		var enemy3 = obj_enemy_hydra_b_controller;
	...
	if (instance_number(obj_enemy_controller_parent) < 3)
		var enemy4 = obj_enemy_hydra_b_controller;
	...
	if (instance_number(obj_enemy_controller_parent) < 3)
		var enemy3 = obj_enemy_hydra_b_controller;
	else var enemy3 = obj_enemy_flamer;
	var enemy4 = obj_enemy_candler;
} else {
	if (instance_number(obj_enemy_controller_parent) < 5)
		var enemy1 = obj_enemy_hydra_b_controller;
	else var enemy1 = obj_enemy_slime;
	if (instance_number(obj_enemy_controller_parent) < 4)
		var enemy2 = obj_enemy_lizard_r_controller;
	else var enemy2 = obj_enemy_slime;
