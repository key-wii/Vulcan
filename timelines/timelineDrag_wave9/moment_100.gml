...
if (seed == 1) {
	...
	var enemy3 = obj_enemy_b_quickshot;
	var enemy4 = obj_enemy_candler;
} else if (seed == 4) {
	if (instance_number(obj_enemy_dragonfly_s) <= 3)
		var enemy1 = obj_enemy_dragonfly_s;
	else var enemy1 = obj_enemy_r_grenader_big;
	var enemy2 = obj_enemy_b_viper;
	var enemy3 = obj_enemy_r_grenader_big;
	var enemy4 = obj_enemy_r_quickshot;
} else if (seed == 5) {
	if (instance_number(obj_enemy_dragonfly_s) <= 3)
		var enemy1 = obj_enemy_dragonfly_s;
	else var enemy1 = obj_enemy_r_viper;
	var enemy2 = obj_enemy_r_viper;
	var enemy3 = obj_enemy_b_quickshot;
	var enemy4 = obj_enemy_s_grenader_big;
} else if (seed == 6) {
	if (instance_number(obj_enemy_dragonfly_s) <= 3)
	...
	if (instance_number(obj_enemy_controller_parent) < 5)
		var enemy1 = obj_enemy_lizard_controller;
	else var enemy1 = obj_enemy_b_circle;
	var enemy2 = obj_enemy_b_circle;
	var enemy3 = obj_enemy_r_circle;
	var enemy4 = obj_enemy_r_circle;
} else if (seed == 12) {
	var enemy1 = obj_enemy_r_viper;
	var enemy2 = obj_enemy_r_viper;
	...
	else var enemy1 = obj_enemy_b_viper;
	var enemy2 = obj_enemy_candler;
	var enemy3 = obj_enemy_b_viper;
	...
	var enemy1 = obj_enemy_s_grenader_big;
	var enemy2 = obj_enemy_r_circle;
	var enemy3 = obj_enemy_candler;
	if (instance_number(obj_enemy_controller_parent) < 5)
		var enemy4 = obj_enemy_lizard_controller;
	else var enemy4 = obj_enemy_r_circle;
