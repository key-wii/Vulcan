...
if (seed == 1) {
	if (instance_number(obj_enemy_dragonfly_s) <= 7)
		var enemy1 = obj_enemy_dragonfly_s;
	else var enemy1 = obj_enemy_candler;
	if (instance_number(obj_enemy_dragonfly_s) <= 6)
		var enemy2 = obj_enemy_dragonfly_s;
	else var enemy2 = obj_enemy_flamer;
	var enemy3 = obj_enemy_slime;
	var enemy4 = obj_enemy_r_grenader_big;
} else if (seed == 2) {
	if (instance_number(obj_enemy_dragonfly_s) <= 7)
		var enemy1 = obj_enemy_dragonfly_s;
	...
	if (instance_number(obj_enemy_dragonfly_s) <= 6)
		var enemy2 = obj_enemy_dragonfly_s;
	else var enemy2 = obj_enemy_r_grenader_big;
	var enemy3 = obj_enemy_b_viper_wide;
	var enemy4 = obj_enemy_r_grenader_big;
} else if (seed == 3) {
	if (instance_number(obj_enemy_dragonfly_s) <= 7)
		var enemy1 = obj_enemy_dragonfly_s;
	else var enemy1 = obj_enemy_b_quickshot;
	if (instance_number(obj_enemy_dragonfly_s) <= 6)
		var enemy2 = obj_enemy_dragonfly_s;
	else var enemy2 = obj_enemy_r_grenader_big;
	var enemy3 = obj_enemy_slime;
	...
	if (instance_number(obj_enemy_dragonfly_s) <= 7)
		var enemy1 = obj_enemy_dragonfly_s;
	else var enemy1 = obj_enemy_r_grenader_big;
	if (instance_number(obj_enemy_dragonfly_s) <= 6)
		var enemy2 = obj_enemy_dragonfly_s;
	else var enemy2 = obj_enemy_b_viper_wide;
	var enemy3 = obj_enemy_r_grenader_big;
	var enemy4 = obj_enemy_r_grenader_big;
} else if (seed == 5) {
	if (instance_number(obj_enemy_dragonfly_s) <= 7)
		var enemy1 = obj_enemy_dragonfly_s;
	else var enemy1 = obj_enemy_r_viper_wide;
	if (instance_number(obj_enemy_dragonfly_s) <= 6)
		var enemy2 = obj_enemy_dragonfly_s;
	else var enemy2 = obj_enemy_b_viper_wide;
	var enemy3 = obj_enemy_r_grenader_big;
	...
	if (instance_number(obj_enemy_dragonfly_s) <= 7)
		var enemy1 = obj_enemy_dragonfly_s;
	else var enemy1 = obj_enemy_flamer;
	if (instance_number(obj_enemy_dragonfly_s) <= 6)
		var enemy2 = obj_enemy_dragonfly_s;
	else var enemy2 = obj_enemy_flamer;
	var enemy3 = obj_enemy_b_viper_wide;
	...
	if (instance_number(obj_enemy_controller_parent) < 4)
		var enemy2 = obj_enemy_hydra_controller;
	else var enemy2 = obj_enemy_slime;
	if (instance_number(obj_enemy_dragonfly_s) <= 6)
		var enemy3 = obj_enemy_dragonfly_s;
	else var enemy3 = obj_enemy_b_viper_wide;
	...
	if (instance_number(obj_enemy_controller_parent) < 4)
		var enemy2 = obj_enemy_hydra_controller;
	else var enemy2 = obj_enemy_b_grenader_big;
	if (instance_number(obj_enemy_dragonfly_s) <= 6)
		var enemy3 = obj_enemy_dragonfly_s;
	else var enemy3 = obj_enemy_b_viper_wide;
	var enemy4 = obj_enemy_r_grenader_big;
	...
	if (instance_number(obj_enemy_dragonfly_s) <= 7)
		var enemy1 = obj_enemy_dragonfly_s;
	else var enemy1 = obj_enemy_slime;
	if (instance_number(obj_enemy_controller_parent) < 4)
		var enemy2 = obj_enemy_hydra_controller;
	else var enemy2 = obj_enemy_b_viper_wide;
	if (instance_number(obj_enemy_dragonfly_s) <= 6)
		var enemy3 = obj_enemy_dragonfly_s;
	else var enemy3 = obj_enemy_r_grenader_big;
	var enemy4 = obj_enemy_candler;
} else if (seed == 11) {
	if (instance_number(obj_enemy_dragonfly_s) <= 7)
		var enemy1 = obj_enemy_dragonfly_s;
	else var enemy1 = obj_enemy_b_viper_wide_circle;
	if (instance_number(obj_enemy_controller_parent) < 3)
		var enemy2 = obj_enemy_lizard_controller;
	else var enemy2 = obj_enemy_slime;
	if (instance_number(obj_enemy_dragonfly_s) <= 6)
		var enemy3 = obj_enemy_dragonfly_s;
	else var enemy3 = obj_enemy_b_viper_wide_circle;
	var enemy4 = obj_enemy_r_viper_wide_circle;
} else if (seed == 12) {
	var enemy1 = obj_enemy_slime;
	if (instance_number(obj_enemy_controller_parent) < 3)
		var enemy2 = obj_enemy_lizard_controller;
	else var enemy2 = obj_enemy_b_viper_wide;
	...
	var enemy1 = obj_enemy_slime;
	if (instance_number(obj_enemy_controller_parent) < 3)
		var enemy2 = obj_enemy_lizard_b_controller;
	else var enemy2 = obj_enemy_b_viper_wide;
	var enemy3 = obj_enemy_r_grenader_big;
	var enemy4 = obj_enemy_r_grenader_big;
} else if (seed == 14) {
	if (instance_number(obj_enemy_controller_parent) < 3)
		var enemy1 = obj_enemy_lizard_b_controller;
	else var enemy1 = obj_enemy_b_viper_wide;
	...
	var enemy2 = obj_enemy_b_viper_wide;
	var enemy3 = obj_enemy_slime;
	var enemy4 = obj_enemy_flamer;
} else if (seed == 16) {
	if (instance_number(obj_enemy_controller_parent) < 3)
	...
	var enemy2 = obj_enemy_slime;
	var enemy3 = obj_enemy_r_viper_wide;
	if (instance_number(obj_enemy_controller_parent) < 4)
		var enemy4 = obj_enemy_hydra_controller;
	else var enemy4 = obj_enemy_candler;
} else if (seed == 17 || seed == 18) {
	if (instance_number(obj_enemy_controller_parent) < 4)
		var enemy1 = obj_enemy_hydra_controller;
	else var enemy1 = obj_enemy_slime;
	var enemy2 = obj_enemy_r_viper_wide_circle;
	var enemy3 = obj_enemy_candler;
	if (instance_number(obj_enemy_controller_parent) < 3)
		var enemy4 = obj_enemy_lizard_controller;
	else var enemy4 = obj_enemy_r_viper_wide_circle;
} else if (seed == 19 || seed == 20) {
	if (instance_number(obj_enemy_controller_parent) < 3)
		var enemy1 = obj_enemy_lizard_controller;
	else var enemy1 = obj_enemy_slime;
	if (instance_number(obj_enemy_controller_parent) < 3)
		var enemy2 = obj_enemy_lizard_b_controller;
	else var enemy2 = obj_enemy_r_grenader_big;
	...
	if (instance_number(obj_enemy_controller_parent) < 2)
		var enemy3 = obj_enemy_lizard_b_controller;
	else var enemy3 = obj_enemy_slime;
	if (instance_number(obj_enemy_controller_parent) < 1)
		var enemy4 = obj_enemy_hydra_controller;
	else var enemy4 = obj_enemy_slime;
}
...
with (obj_tank_pilot) {
	...
	if (_spawnNum >= 1) {
		...
		if (enemy == obj_enemy_candler || enemy == obj_enemy_candler_big || enemy == obj_enemy_flamer ||
			string_count("controller", object_get_name(enemy)) > 0 || string_count("slime", object_get_name(enemy)) > 0)
				lCap += 300;
		...
		if (enemy == obj_enemy_dragonfly_s) spawn1.set_dir = instance_number(obj_enemy_dragonfly_s) * 90;
	}
	...
	if (_spawnNum >= 2) {
		...
		if (enemy == obj_enemy_dragonfly_s) spawn2.set_dir = instance_number(obj_enemy_dragonfly_s) * 90;
	}
	...
	if (_spawnNum >= 3) {
		...
		if (enemy == obj_enemy_dragonfly_s) spawn3.set_dir = instance_number(obj_enemy_dragonfly_s) * 90;
	}
	...
	if (_spawnNum >= 4) {
		...
		if (enemy == obj_enemy_dragonfly_s) spawn4.set_dir = instance_number(obj_enemy_dragonfly_s) * 90;
	}
}
