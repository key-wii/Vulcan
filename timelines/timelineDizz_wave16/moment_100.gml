...
if (seed == 1) {
	...
	if (instance_number(obj_enemy_mage_viper_wide_circle) < 6)
	...
	if (instance_number(obj_enemy_mage_viper_wide_circle) < 5)
...
with (obj_tank_pilot) {
	...
	if (_spawnNum >= 1) {
		...
		if (enemy == obj_enemy_candler || enemy == obj_enemy_candler_big ||
			enemy == obj_enemy_candler_big_dizzy || enemy == obj_enemy_flamer ||
