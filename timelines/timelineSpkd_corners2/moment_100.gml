...
if (seed == 1) {
	...
	spawn4.enemy = obj_enemy_flamer_fast_spiked2;
	passes = -1;
} else if (seed == 2) {
	spawn1.enemy = obj_enemy_candler_spiked;
	spawn2.enemy = obj_enemy_candler_spiked;
	spawn3.enemy = obj_enemy_flamer_fast_spiked2;
	spawn4.enemy = obj_enemy_candler_spiked;
	passes = -1;
} else if (seed == 3) {
	spawn1.enemy = obj_enemy_candler_spiked;
	spawn2.enemy = obj_enemy_flamer_fast_spiked2;
	spawn3.enemy = obj_enemy_candler_spiked;
	spawn4.enemy = obj_enemy_candler_spiked;
	passes = -1;
} else if (seed == 4) {
	spawn1.enemy = obj_enemy_flamer_fast_spiked2;
	spawn2.enemy = obj_enemy_candler_spiked;
	spawn3.enemy = obj_enemy_candler_spiked;
	spawn4.enemy = obj_enemy_candler_spiked;
	passes = -1;
