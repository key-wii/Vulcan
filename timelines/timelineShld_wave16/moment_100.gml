...
if (seed == 1) {
	...
	var enemy1 = obj_enemy_b_viper_wide;
	if (instance_number(obj_enemy_bbbird_s) <= 3)
		var enemy2 = obj_enemy_bbbird_s;
	else var enemy2 = obj_enemy_flamer_fast;
	var enemy3 = obj_enemy_r_viper_wide_circle;
	...
	if (instance_number(obj_enemy_SH_shield) <= 1)
		var enemy4 = obj_enemy_SH1_fast;
	else var enemy4 = obj_enemy_b_viper_wide;
} else if (seed == 6) {
	var enemy1 = obj_enemy_flamer_fast;
	if (instance_number(obj_enemy_bbbird_s) <= 3)
		var enemy2 = obj_enemy_bbbird_s;
	else var enemy2 = obj_enemy_b_viper_wide;
	var enemy3 = obj_enemy_s_viper_wide_circle;
	if (instance_number(obj_enemy_SH_shield) <= 1)
		var enemy4 = obj_enemy_SH1_fast;
	else var enemy4 = obj_enemy_r_quickshot;
} else if (seed == 7) {
	var enemy1 = obj_enemy_candler;
	if (instance_number(obj_enemy_bbbird_s) <= 3)
		var enemy2 = obj_enemy_bbbird_s;
	else var enemy2 = obj_enemy_b_viper_wide;
	var enemy3 = obj_enemy_flamer_fast;
	...
	var enemy3 = obj_enemy_candler;
	var enemy4 = obj_enemy_r_viper_wide;
} else if (seed == 9) {
	var enemy1 = obj_enemy_candler;
	...
	if (instance_number(obj_enemy_SH_shield) <= 2)
		var enemy1 = obj_enemy_SH1_fast;
	...
	var enemy2 = obj_enemy_flamer_fast;
	var enemy3 = obj_enemy_b_viper_wide;
	var enemy4 = obj_enemy_r_grenader_big;
	...
	var enemy3 = obj_enemy_r_viper_wide_circle;
	if (instance_number(obj_enemy_SH2) == 0)
		var enemy4 = obj_enemy_SH2;
	else var enemy4 = obj_enemy_flamer_fast;
} else if (seed == 19 || seed == 20) {
	if (instance_number(obj_enemy_miner) < 1)
		var enemy1 = obj_enemy_miner;
	else var enemy1 = obj_enemy_b_viper_wide;
	...
	if (instance_number(obj_enemy_miner) < 1)
		var enemy1 = obj_enemy_miner;
	else var enemy1 = obj_enemy_flamer_fast;
	if (instance_number(obj_enemy_SH_shield) <= 2)
		var enemy2 = obj_enemy_SH1_fast;
	else var enemy2 = obj_enemy_flamer_fast;
	var enemy3 = obj_enemy_r_viper_wide_circle;
	var enemy4 = obj_enemy_flamer_fast;
}
...
with (obj_tank_pilot) {
	...
	if (_spawnNum >= 1) {
		...
		if (enemy == obj_enemy_candler || enemy == obj_enemy_candler_big || enemy == obj_enemy_flamer ||
			enemy == obj_enemy_flamer_fast || enemy == obj_enemy_miner || string_count("controller", object_get_name(enemy)) > 0)
				lCap += 300;
