...
if (seed == 1) {
	...
	var enemy2 = obj_enemy_s_grenader_big;
	var enemy3 = obj_enemy_slime;
	...
	var enemy2 = obj_enemy_flamer;
	var enemy3 = obj_enemy_s_grenader_big;
	var enemy4 = obj_enemy_b_grenader_big;
} else if (seed == 8) {
	if (instance_number(obj_enemy_dragonfly_s) <= 3)
		var enemy1 = obj_enemy_dragonfly_s;
	...
	var enemy2 = obj_enemy_b_quickshot;
	var enemy4 = obj_enemy_b_viper_wide;
	var enemy3 = obj_enemy_s_grenader_big;
} else if (seed == 10) {
	...
	var enemy3 = obj_enemy_r_viper_wide_circle;
	...
	if (instance_number(obj_enemy_controller_parent) < 2)
		var enemy2 = obj_enemy_lizard_controller;
	else var enemy2 = obj_enemy_b_quickshot;
	var enemy3 = obj_enemy_b_grenader_big;
	var enemy4 = obj_enemy_r_grenader_big;
} else if (seed == 14) {
	if (instance_number(obj_enemy_controller_parent) < 2)
	...
	var enemy2 = obj_enemy_slime;
	var enemy3 = obj_enemy_r_quickshot;
	if (instance_number(obj_enemy_controller_parent) < 2)
		var enemy4 = obj_enemy_lizard_b_controller;
