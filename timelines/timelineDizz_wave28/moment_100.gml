...
if (seed == 1) {
	if (instance_number(obj_enemy_r_3round_circle) <= 4)
		var enemy1 = obj_enemy_r_3round_circle;
	else var enemy1 = obj_enemy_candler;
	var enemy2 = obj_enemy_slime_dizzy;
	if (instance_number(obj_enemy_dizzy_viper) < 12)
		var enemy3 = obj_enemy_dizzy_viper;
	else var enemy3 = obj_enemy_s_grenader_big;
	var enemy4 = obj_enemy_b_3round;
} else if (seed == 2) {
	if (instance_number(obj_enemy_r_3round_circle) <= 4)
		var enemy1 = obj_enemy_r_3round_circle;
	else var enemy1 = obj_enemy_dizzy_viper;
	var enemy2 = obj_enemy_r_viper_wide_circle;
	var enemy3 = obj_enemy_r_viper_wide;
	if (instance_number(obj_enemy_dizzy_viper) < 12)
		var enemy4 = obj_enemy_dizzy_viper;
	...
	if (instance_number(obj_enemy_dizzy_viper) < 12)
		var enemy1 = obj_enemy_dizzy_viper;
	else var enemy1 = obj_enemy_s_grenader_big;
	if (instance_number(obj_enemy_dizzy_3round) < 5)
		var enemy2 = obj_enemy_dizzy_3round;
	else var enemy2 = obj_enemy_r_viper_wide;
	if (!instance_exists(obj_enemy_candler_big_dizzy))
		var enemy3 = obj_enemy_candler_big_dizzy;
	else var enemy3 = obj_enemy_slime_dizzy;
	if (instance_number(obj_enemy_r_3round_circle) <= 3)
		var enemy4 = obj_enemy_r_3round_circle;
	else var enemy4 = obj_enemy_b_3round;
} else if (seed == 5) {
	var enemy1 = obj_enemy_b_3round;
	if (instance_number(obj_enemy_r_3round_circle) <= 4)
		var enemy2 = obj_enemy_r_3round_circle;
	...
	if (instance_number(obj_enemy_dizzy_3round) < 5)
		var enemy1 = obj_enemy_dizzy_3round;
	...
	if (instance_number(obj_enemy_dizzy_viper) < 12)
		var enemy2 = obj_enemy_dizzy_viper;
	else var enemy2 = obj_enemy_b_viper_wide;
	if (!instance_exists(obj_enemy_candler_big_dizzy))
		var enemy3 = obj_enemy_candler_big_dizzy;
	else var enemy3 = obj_enemy_slime_dizzy;
	...
	if (instance_number(obj_enemy_dizzy_viper) < 11)
		var enemy4 = obj_enemy_dizzy_viper;
	...
	if (instance_number(obj_enemy_dizzy_viper) < 10)
		var enemy2 = obj_enemy_dizzy_viper;
	...
	if (instance_number(obj_enemy_dizzy_3round) < 4)
		var enemy4 = obj_enemy_dizzy_3round;
