...
if (seed == 1) {
	...
	if (instance_number(obj_enemy_mage_big_circle) < 9)
		var enemy1 = obj_enemy_mage_big_circle;
	else var enemy1 = obj_enemy_s_viper_wide_circle;
	...
	if (instance_number(obj_enemy_mage_viper_circle) < 6)
		var enemy1 = obj_enemy_mage_viper_circle;
	else var enemy1 = obj_enemy_b_viper_wide_circle;
	if (instance_number(obj_enemy_mage_big_circle) < 9)
		var enemy2 = obj_enemy_mage_big_circle;
	else var enemy2 = obj_enemy_candler;
	...
	if (instance_number(obj_enemy_mage_viper_circle) < 6)
		var enemy1 = obj_enemy_mage_viper_circle;
	else var enemy1 = obj_enemy_s_3round;
	if (instance_number(obj_enemy_mage_viper_circle) < 5)
		var enemy2 = obj_enemy_mage_viper_circle;
	else var enemy2 = obj_enemy_flamer;
	var enemy3 = obj_enemy_b_viper_wide_circle;
	...
	if (instance_number(obj_enemy_mage_viper_circle) < 5)
		var enemy3 = obj_enemy_mage_viper_circle;
	else var enemy3 = obj_enemy_slime;
	if (instance_number(obj_enemy_mage_viper_circle) < 4)
		var enemy4 = obj_enemy_mage_viper_circle;
