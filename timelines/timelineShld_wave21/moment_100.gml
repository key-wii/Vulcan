...
if (seed == 1) {
	...
	else var enemy1 = obj_enemy_r_viper_circle;
	...
	var enemy1 = obj_enemy_b_grenader_big;
	var enemy2 = obj_enemy_r_viper_wide;
	var enemy3 = obj_enemy_candler;
	var enemy4 = obj_enemy_b_viper_wide;
} else if (seed == 5) {
	var enemy1 = obj_enemy_r_viper_circle;
	var enemy2 = obj_enemy_b_viper_wide;
	var enemy3 = obj_enemy_r_viper_wide;
	var enemy4 = obj_enemy_b_viper_wide;
} else if (seed == 6) {
	...
	if (instance_number(obj_enemy_SH1_fast) < 2)
		var enemy2 = obj_enemy_SH1_fast;
	else var enemy2 = obj_enemy_r_viper_wide;
	if (instance_number(obj_enemy_SH1_fast_circle) <= 1)
		var enemy3 = obj_enemy_SH1_fast_circle;
	else var enemy3 = obj_enemy_b_viper_wide;
	var enemy4 = obj_enemy_flamer_fast;
} else {
	if (instance_number(obj_enemy_miner) < 1)
	...
	if (instance_number(obj_enemy_SH1_fast_circle) <= 1)
		var enemy2 = obj_enemy_SH1_fast_circle;
