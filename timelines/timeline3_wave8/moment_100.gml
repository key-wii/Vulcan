...
if (seed == 1 || seed == 2) {
	...
	var enemy2 = obj_enemy_r_quickshot;
	var enemy3 = obj_enemy_candler;
...
//Less enemies means more enemies need to spawn in quicker
     if (enemies < 6) timeline_position = 550;
else if (enemies < 8) timeline_position = 500;
else if (enemies < 10) timeline_position = 450;
else if (enemies < 12) timeline_position = 400;
else if (enemies < 14) timeline_position = 350;
else if (enemies < 16) timeline_position = 300;
else if (enemies < 18) timeline_position = 250;