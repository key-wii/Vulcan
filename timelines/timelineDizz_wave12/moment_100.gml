...
if (seed == 1) {
	...
	else var enemy2 = obj_enemy_slime_dizzy;
	...
	else var enemy4 = obj_enemy_s_3round;
} else if (seed == 5) {
	...
	if (instance_number(obj_enemy_mage_viper_circle) < 6)
		var enemy2 = obj_enemy_mage_viper_circle;
	else var enemy2 = obj_enemy_s_3round;
	if (instance_number(obj_enemy_mage_viper_circle) < 5)
	...
	if (instance_number(obj_enemy_dizzy_viper_circle) < 9)
		var enemy1 = obj_enemy_dizzy_viper_circle;
	else var enemy1 = obj_enemy_slime_dizzy;
	if (instance_number(obj_enemy_dizzy_viper_circle) < 8)
		var enemy2 = obj_enemy_dizzy_viper_circle;
	else var enemy2 = obj_enemy_flamer;
	if (instance_number(obj_enemy_mage_viper_circle) < 6)
