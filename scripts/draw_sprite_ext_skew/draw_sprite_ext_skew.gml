...
function draw_sprite_ext_skew() {
	...
	// get the arguments:
	var sprite = argument[0], subimg = argument[1], _x = argument[2], _y = argument[3],
	    scalex = argument[4], scaley = argument[5], rot = argument[6], alpha = argument[7],
	    skew_kx = argument[8], skew_ky = argument[9], skew_sx = argument[10], skew_sy = argument[11];
