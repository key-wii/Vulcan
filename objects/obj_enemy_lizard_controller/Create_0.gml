...
image_speed = radius / 180 / 3;
xx1 = lengthdir_x(radius, 210); yy1 = lengthdir_y(radius, 210);
xx2 = lengthdir_x(radius, 330); yy2 = lengthdir_y(radius, 330);
head[0] = instance_create_layer(x + xx1, y + yy1, "Enemy", obj_enemy_lizard);
head[1] = instance_create_layer(x + xx2, y + yy2, "Enemy", obj_enemy_lizard);
head[2] = instance_create_layer(x, y - radius, "Enemy", obj_enemy_lizard);
