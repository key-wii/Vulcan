...
head[0] = instance_create_layer(x + xx1, y + yy1, "Enemy", obj_enemy_hydra_b);
head[1] = instance_create_layer(x + xx2, y + yy2, "Enemy", obj_enemy_hydra_b);
head[2] = instance_create_layer(x, y - radius, "Enemy", obj_enemy_hydra_b);
