	...
	if(broken_shield || !shielding) {
		...
		with (other) {
			...
			if (initial_damage == 16 || initial_damage == 40 || initial_damage == 60
				/*|| initial_damage == 20 || initial_damage == 24 || initial_damage == 28
				|| initial_damage == 32 || initial_damage == 36  || initial_damage == 44
				|| initial_damage == 48 || initial_damage == 52  || initial_damage == 56
				|| initial_damage == 64 || initial_damage == 68  || initial_damage == 72*/)
					pow /= 2;
			alarm_set(11, 2);
		}
