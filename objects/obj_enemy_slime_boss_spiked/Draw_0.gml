...
var xx = lengthdir_x((sprite_width / 2) - (18 * image_xscale), ddir);
var yy = lengthdir_y((sprite_width / 2) - (18 * image_xscale), ddir);
draw_sprite_ext(spr_enemy_spike_b, 0, x + xx, y + yy, image_xscale, image_yscale, direction, c_white, 1);
	ddir = direction + 210;
	xx = lengthdir_x((sprite_width / 2.22) - (4 * image_xscale), ddir);
	yy = lengthdir_y((sprite_width / 2.22) - (4 * image_xscale), ddir);
...
draw_sprite_ext(spr_enemy_spike_b, 0, x + xx, y + yy, image_xscale, image_yscale, direction - 30, c_white, 1);
	ddir = direction + 240;
	xx = lengthdir_x((sprite_width / 2.26) - (6 * image_xscale), ddir);
	yy = lengthdir_y((sprite_width / 2.26) - (6 * image_xscale), ddir);
draw_sprite_ext(spr_enemy_spike_b, 0, x + xx, y + yy, image_xscale, image_yscale, direction + 60, c_white, 1);
	ddir = direction - 240;
	xx = lengthdir_x((sprite_width / 2.26) - (6 * image_xscale), ddir);
	yy = lengthdir_y((sprite_width / 2.26) - (6 * image_xscale), ddir);
draw_sprite_ext(spr_enemy_spike_b, 0, x + xx, y + yy, image_xscale, image_yscale, direction - 60, c_white, 1);
	ddir = direction;
	xx = lengthdir_x((sprite_width / 2) - (5 * image_xscale), ddir);
	yy = lengthdir_y((sprite_width / 2) - (5 * image_xscale), ddir);
draw_sprite_ext(spr_enemy_spike_g, 0, x + xx, y + yy, image_xscale, image_yscale, direction + 180, c_white, 1);
