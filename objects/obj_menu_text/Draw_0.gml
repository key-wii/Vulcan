...
draw_text_ext(x - 293, y - 96 + textHeight * 0, textPart1, textHeight, boxWidth - 10);
draw_text_ext(x - 293, y - 96 + textHeight * 1, textPart2, textHeight, boxWidth - 10);
draw_text_ext(x - 293, y - 96 + textHeight * 2, textPart3, textHeight, boxWidth - 10);
draw_text_ext(x - 293, y - 96 + textHeight * 3, textPart4, textHeight, boxWidth - 10);
draw_text_ext(x - 293, y - 96 + textHeight * 4, textPart5, textHeight, boxWidth - 10);