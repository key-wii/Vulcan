...
if (!h1) {
	...
	head[0].image_xscale = 2; head[0].image_yscale = 2; 
	head[0].enemy = obj_enemy_hydra_boss;
	head[0].owner = id;
	head[0].index = 0;
...
if (!h2) {
	...
	head[1].image_xscale = 2; head[1].image_yscale = 2; 
	head[1].enemy = obj_enemy_hydra_boss;
	head[1].owner = id;
	head[1].index = 1;
...
if (!h3) {
	...
	head[2].image_xscale = 2; head[2].image_yscale = 2; 
	head[2].enemy = obj_enemy_hydra_boss;
	head[2].owner = id;
	head[2].index = 2;
